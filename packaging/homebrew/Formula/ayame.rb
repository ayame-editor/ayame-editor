class Ayame < Formula
  ...
  if OS.mac? && Hardware::CPU.arm?
    url "https://github.com/hjosugi/ayame-editor/releases/download/v0.7.5/ayame-v0.7.5-macos-aarch64.zip"
    sha256 "08e682ed0a89dd3345f143fdc1a3552ab197713f8a6640e3a54b87b69668416c"
  elsif OS.mac?
    url "https://github.com/hjosugi/ayame-editor/releases/download/v0.7.5/ayame-v0.7.5-macos-x86_64.zip"
    sha256 "d505b3130ce2621198bbfb8eb030ffcf73873d5e6b7faee1a9e26e720e4dc18b"
  elsif OS.linux? && Hardware::CPU.intel?
    url "https://github.com/hjosugi/ayame-editor/releases/download/v0.7.5/ayame-v0.7.5-linux-x86_64"
