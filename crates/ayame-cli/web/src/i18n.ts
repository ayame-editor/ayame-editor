...
export const MESSAGES = {
  ja: {
    ...
    "menu.selection": "選択",
    "menu.view": "表示",
    "fold.toggle": "現在の折りたたみを切り替え",
    "fold.currentLevel": "現在のレベルを折りたたむ",
    "fold.unfoldCurrentLevel": "現在のレベルを展開",
    "fold.unfoldAll": "すべて展開",
    "fold.toLevel": "レベル {level} まで折りたたむ",
    "fold.toLevelPrompt": "指定レベルまで折りたたむ…",
    "fold.levelLabel": "折りたたむレベル (1 以上)",
    "fold.goStart": "ブロックの先頭へ移動",
    "fold.goEnd": "ブロックの末尾へ移動",
    "fold.previousSibling": "前の同階層ブロックへ移動",
    "fold.nextSibling": "次の同階層ブロックへ移動",
    "fold.matchBrace": "対応する括弧へ移動",
    "fold.selectBrace": "対応する括弧まで選択",
    "fold.expandLine": "{line} 行目の折りたたみを展開",
    "fold.collapseLine": "{line} 行目を折りたたむ",
    "fold.hiddenLines": "… {count} 行を非表示",
    "fold.badgeBookmarks": "ブックマーク {count}",
    "fold.badgeChanges": "変更 {count}",
    "fold.badgeMatches": "一致 {count}",
    "fold.scanning": "文書構造をスキャンしています…",
    "fold.scannedLines": "{count} 行を確認しました",
    "fold.scanError": "文書構造を読み取れませんでした",
    "fold.unsupported": "このシンタックスには折りたたみ構造がありません",
    "fold.noMatchingBrace": "対応する括弧が見つかりません",
    "menu.tools": "ツール",
    "menu.help": "ヘルプ",
    "menu.window": "ウインドウ",
    "menu.minimize": "しまう",
    ...
    "menu.wordWrap": "折り返し",
    "inputAssist.autoIndent": "自動インデント",
    "inputAssist.closePairs": "括弧・引用符を自動で閉じる",
    "inputAssist.selectionEnclosure": "選択範囲を括弧・引用符で囲む",
    "inputAssist.wordCompletion": "単語補完",
    "completion.show": "単語補完を表示",
    "completion.label": "単語補完候補",
    "completion.loading": "文書内の候補を検索中",
    "completion.timedOut": "時間内に見つかった候補を表示しています",
    "completion.empty": "補完候補がありません",
    "inspect.title": "文字・生バイトを検査",
    "inspect.loading": "現在位置を検査しています…",
    "inspect.error": "検査エラー: {msg}",
    "inspect.summary":
      "{encoding} · グラフェム {graphemes} · スカラー {scalars} · UTF-8 {utf8} bytes · UTF-16 {utf16} units",
    "inspect.position": "{line} 行 {col} 列",
    "inspect.bom": "BOM",
    "inspect.noBom": "BOM なし",
    "inspect.unassigned": "未割り当て",
    "inspect.codePoints": "コードポイント",
    "inspect.cellWidth": "セル幅",
    "inspect.utf8Hex": "UTF-8 hex",
    "inspect.utf16Hex": "UTF-16 hex",
    "inspect.byteOffset": "元ファイル byte offset",
    "inspect.rawHex": "生バイト",
    "inspect.originalEncodingHex": "元エンコーディング hex",
    "inspect.overlay": "編集オーバーレイ",
    "inspect.unavailable": "元バイトなし",
    "inspect.unrepresentable": "表現不可",
    "inspect.copyActions": "検査値をコピー",
    "inspect.copyText": "文字をコピー",
    "inspect.copyCodePoints": "U+ をコピー",
    "inspect.copyEscapes": "Unicode エスケープをコピー",
    "inspect.copyUtf8": "UTF-8 hex をコピー",
    "inspect.copyEncoded": "元エンコーディング hex をコピー",
    "inspect.copyRaw": "生バイトをコピー",
    "inspect.copyByteEscapes": "\\x byte escape をコピー",
    "inspect.copied": "検査値をそのままコピーしました",
    "inspect.copyError": "クリップボードへコピーできませんでした",
    "inspect.expressionTitle": "明示表現を変換",
    "inspect.expressionLabel": "U+、Unicode エスケープ、または byte エスケープ",
    "inspect.expressionHint": "U+3042、\\u{3042}、\\x82\\xA0 のように明示指定します",
    "inspect.parse": "解析",
    "inspect.replace": "選択文字を置換",
    "inspect.stale": "文書または選択位置が変わりました。もう一度検査してください",
    "inspect.singleRangeOnly": "矩形選択または複数カーソルは、1範囲ずつ検査してください",
    "inspect.colorTitle": "色リテラル",
    "inspect.colorPicker": "RGB 色",
    "inspect.alpha": "Alpha",
    "inspect.applyColor": "色を適用",
    "inspect.diag.bidiControl": "Bidi 方向制御文字",
    "inspect.diag.zeroWidthSpace": "ゼロ幅スペース",
    "inspect.diag.zeroWidthNonJoiner": "ゼロ幅非接合子",
    "inspect.diag.zeroWidthJoiner": "ゼロ幅接合子",
    "inspect.diag.nonBreakingSpace": "改行禁止スペース",
    "inspect.diag.softHyphen": "ソフトハイフン",
    "inspect.diag.variationSelector": "異体字セレクタ",
    "inspect.diag.replacementCharacter": "復号置換文字",
    "inspect.diag.controlCharacter": "制御文字",
    "inspect.diag.unrepresentable": "現在の文字コードでは表現不可",
    "inspect.diag.decodeMismatch": "生バイトと再エンコード結果が不一致",
    "inspect.diag.lineEnding": "改行またはファイル末尾",
    "inspect.diag.mixedScript": "複数スクリプト混在（confusable の可能性）",
    "inspect.diag.truncated":
      "安全上限（16行 / 64グラフェム / 256スカラー / 16 KiB）で検査結果を打ち切りました",
    ...
    "externalAction.title": "外部分析アクション",
    "externalAction.menuTitle": "シェルを介さず、確認済みの外部分析ツールを実行します",
    "externalAction.name": "名前",
    "externalAction.configJson": "Action JSON を import (任意)",
    "externalAction.configJsonPlaceholder": "貼り付けた設定は実行前に再確認します",
    "externalAction.configJsonHint": "現在の設定 JSON (export 用): {json}",
    "externalAction.executable": "実行ファイル",
    "externalAction.arguments": "引数 (JSON 配列)",
    "externalAction.argumentsHint": '例: ["--input","{snapshot_file}"]。シェル文字列ではありません',
    "externalAction.argumentsArrayError": "引数は文字列だけの JSON 配列にしてください",
    "externalAction.input": "入力",
    "externalAction.inputFile": "保存済みファイル",
    "externalAction.inputSnapshot": "現在の固定スナップショット",
    "externalAction.inputSelectionStdin": "選択範囲を標準入力へ",
    "externalAction.inputSelectionFile": "選択範囲を非公開一時ファイルへ",
    "externalAction.output": "出力",
    "externalAction.outputPanel": "結果パネル",
    "externalAction.outputTab": "新しい一時タブ",
    "externalAction.outputFile": "出力ファイル",
    "externalAction.outputPath": "出力先パス",
    "externalAction.workingDirectory": "作業フォルダー",
    "externalAction.timeout": "タイムアウト (秒)",
    "externalAction.maxOutput": "最大出力 (MiB、stdout+stderr)",
    "externalAction.placeholderHint":
      "プレースホルダー: {file} {dir} {line} {column} {selection_file} {snapshot_file}。環境変数は親プロセスから継承されますが、値は画面やログに表示しません。",
    "externalAction.invalidConfig": "外部アクションの設定が不正です",
    "externalAction.selectionRequired": "この入力方式には選択範囲が必要です",
    "externalAction.outputPathRequired": "ファイル出力には出力先パスが必要です",
    "externalAction.confirmTitle": "外部プログラムを実行しますか？",
    "externalAction.confirmWarning":
      "表示した実行ファイルと引数配列を確認してください。リポジトリ由来の設定は自動では信頼されません。",
    "externalAction.running": "{name} を実行中…",
    "externalAction.failed": "外部アクションを実行できませんでした",
    "externalAction.exitCode": "終了コード",
    "externalAction.duration": "実行時間",
    "externalAction.canceled": "キャンセル",
    "externalAction.timedOut": "タイムアウト",
    "externalAction.noExitCode": "不明",
    "externalAction.outputTruncated": "設定した出力上限で打ち切りました",
    "externalAction.empty": "(空)",
    "recognition.open": "選択したパスまたは URL を開く",
    "recognition.confirmTitle": "外部の対象を開きますか？",
    "recognition.kind.file": "ファイル",
    "recognition.kind.directory": "フォルダー",
    "recognition.kind.url": "Web URL",
    "recognition.directory": "認識したフォルダー",
    ...
    "common.save": "保存",
    "common.remove": "削除",
    "syntax.settings": "シンタックススキーム",
    "syntax.manage": "スキームを管理…",
    "syntax.choose": "シンタックススキームを選択",
    "syntax.current": "現在のタブ",
    "syntax.allSchemes": "すべてのスキーム",
    "syntax.searchPlaceholder": "スキーム・拡張子を検索",
    "syntax.assignExtension": "この拡張子へ割り当て",
    "syntax.mappings": "ファイル名・glob の割り当て（上から優先）",
    "syntax.auto": "Auto（ファイル名から判定）",
    "syntax.autoValue": "Auto · {scheme}",
    "syntax.statusValue": "シンタックススキーム: {value}",
    "syntax.scheme": "スキーム",
    "syntax.glob": "ファイル名または glob",
    "syntax.addFavorite": "favorite に追加",
    "syntax.removeFavorite": "favorite から削除",
    "syntax.selectScheme": "{scheme} を現在のタブへ設定",
    "syntax.moveUp": "上へ移動",
    "syntax.moveDown": "下へ移動",
    "syntax.import": "Import",
    "syntax.export": "Export",
    "syntax.importPrompt": "シンタックス設定 JSON を貼り付けてください",
    "syntax.importPartial": "{count} 件の壊れた項目を除外して読み込みました",
    "syntax.importReady": "設定を読み込みました。保存すると反映されます",
    "syntax.importError": "シンタックス設定 JSON を読み込めません",
    "syntax.exported": "シンタックス設定 JSON をクリップボードへコピーしました",
    "syntax.exportError": "クリップボードへコピーできません",
    "syntax.savePartial": "{count} 件の無効な割り当てを除外して保存しました",
    "syntax.category.text": "テキスト",
    "syntax.category.data": "データ",
    "syntax.category.config": "設定",
    "syntax.category.markup": "マークアップ",
    "syntax.category.log": "ログ",
    "syntax.category.programming": "プログラミング",
    "syntax.category.build": "ビルド",
    "syntax.scheme.plain": "Plain Text",
    "syntax.scheme.json": "JSON / JSONC",
    "syntax.scheme.yaml": "YAML",
    "syntax.scheme.toml": "TOML",
    "syntax.scheme.ini": "INI / properties",
    "syntax.scheme.csv": "CSV",
    "syntax.scheme.tsv": "TSV",
    "syntax.scheme.markdown": "Markdown",
    "syntax.scheme.html": "HTML",
    "syntax.scheme.xml": "XML",
    "syntax.scheme.log": "Log",
    "syntax.scheme.javascript": "JavaScript / TypeScript",
    "syntax.scheme.python": "Python",
    "syntax.scheme.rust": "Rust",
    "syntax.scheme.go": "Go",
    "syntax.scheme.c": "C / C++",
    "syntax.scheme.java": "Java",
    "syntax.scheme.csharp": "C#",
    "syntax.scheme.sql": "SQL",
    "syntax.scheme.shell": "Shell",
    "syntax.scheme.css": "CSS / SCSS",
    "syntax.scheme.dockerfile": "Dockerfile",
    "syntax.scheme.makefile": "Makefile",
    "syntax.scheme.nginx": "nginx config",
    "syntax.scheme.apache": "Apache config",
  ...
  en: {
    ...
    "menu.view": "View",
    "fold.toggle": "Toggle Current Fold",
    "fold.currentLevel": "Fold Current Level",
    "fold.unfoldCurrentLevel": "Unfold Current Level",
    "fold.unfoldAll": "Unfold All",
    "fold.toLevel": "Fold to Level {level}",
    "fold.toLevelPrompt": "Fold to Level…",
    "fold.levelLabel": "Fold level (1 or greater)",
    "fold.goStart": "Go to Block Start",
    "fold.goEnd": "Go to Block End",
    "fold.previousSibling": "Go to Previous Sibling Block",
    "fold.nextSibling": "Go to Next Sibling Block",
    "fold.matchBrace": "Go to Matching Brace",
    "fold.selectBrace": "Select to Matching Brace",
    "fold.expandLine": "Expand fold at line {line}",
    "fold.collapseLine": "Fold line {line}",
    "fold.hiddenLines": "… {count} lines hidden",
    "fold.badgeBookmarks": "{count} bookmarks",
    "fold.badgeChanges": "{count} changes",
    "fold.badgeMatches": "{count} matches",
    "fold.scanning": "Scanning document structure…",
    "fold.scannedLines": "Scanned {count} lines",
    "fold.scanError": "Could not scan the document structure",
    "fold.unsupported": "The current syntax has no folding structure",
    "fold.noMatchingBrace": "No matching brace was found",
    "menu.tools": "Tools",
    "menu.help": "Help",
    "menu.window": "Window",
    ...
    "inputAssist.autoIndent": "Auto Indent",
    "inputAssist.closePairs": "Auto-close Brackets and Quotes",
    "inputAssist.selectionEnclosure": "Enclose Selection with Brackets or Quotes",
    "inputAssist.wordCompletion": "Word Completion",
    "completion.show": "Show Word Completion",
    "completion.label": "Word completion suggestions",
    "completion.loading": "Searching document words",
    "completion.timedOut": "Showing suggestions found before the deadline",
    "completion.empty": "No completion suggestions",
    "inspect.title": "Inspect Character and Raw Bytes",
    "inspect.loading": "Inspecting the current position...",
    "inspect.error": "Inspection error: {msg}",
    "inspect.summary":
      "{encoding} · {graphemes} graphemes · {scalars} scalars · {utf8} UTF-8 bytes · {utf16} UTF-16 units",
    "inspect.position": "Line {line}, column {col}",
    "inspect.bom": "BOM",
    "inspect.noBom": "No BOM",
    "inspect.unassigned": "Unassigned",
    "inspect.codePoints": "Code points",
    "inspect.cellWidth": "Cell width",
    "inspect.utf8Hex": "UTF-8 hex",
    "inspect.utf16Hex": "UTF-16 hex",
    "inspect.byteOffset": "Original file byte offset",
    "inspect.rawHex": "Raw bytes",
    "inspect.originalEncodingHex": "Original-encoding hex",
    "inspect.overlay": "Edit overlay",
    "inspect.unavailable": "No original bytes",
    "inspect.unrepresentable": "Not representable",
    "inspect.copyActions": "Copy inspected values",
    "inspect.copyText": "Copy Character",
    "inspect.copyCodePoints": "Copy U+ Values",
    "inspect.copyEscapes": "Copy Unicode Escapes",
    "inspect.copyUtf8": "Copy UTF-8 Hex",
    "inspect.copyEncoded": "Copy Original-Encoding Hex",
    "inspect.copyRaw": "Copy Raw Bytes",
    "inspect.copyByteEscapes": "Copy \\x Byte Escapes",
    "inspect.copied": "Copied the inspected value unchanged",
    "inspect.copyError": "Could not copy to the clipboard",
    "inspect.expressionTitle": "Convert Explicit Representation",
    "inspect.expressionLabel": "U+, Unicode escape, or byte escape",
    "inspect.expressionHint": "Use an explicit form such as U+3042, \\u{3042}, or \\x82\\xA0",
    "inspect.parse": "Parse",
    "inspect.replace": "Replace Inspected Text",
    "inspect.stale": "The document or selection changed. Inspect it again",
    "inspect.singleRangeOnly":
      "Inspect rectangular selections and multiple cursors one range at a time",
    "inspect.colorTitle": "Color Literal",
    "inspect.colorPicker": "RGB color",
    "inspect.alpha": "Alpha",
    "inspect.applyColor": "Apply Color",
    "inspect.diag.bidiControl": "Bidi directional control",
    "inspect.diag.zeroWidthSpace": "Zero-width space",
    "inspect.diag.zeroWidthNonJoiner": "Zero-width non-joiner",
    "inspect.diag.zeroWidthJoiner": "Zero-width joiner",
    "inspect.diag.nonBreakingSpace": "Non-breaking space",
    "inspect.diag.softHyphen": "Soft hyphen",
    "inspect.diag.variationSelector": "Variation selector",
    "inspect.diag.replacementCharacter": "Decode replacement character",
    "inspect.diag.controlCharacter": "Control character",
    "inspect.diag.unrepresentable": "Not representable in the current encoding",
    "inspect.diag.decodeMismatch": "Raw bytes differ from re-encoded text",
    "inspect.diag.lineEnding": "Line ending or end of file",
    "inspect.diag.mixedScript": "Mixed scripts (possible confusable)",
    "inspect.diag.truncated":
      "Inspection stopped at the safety limit (16 lines / 64 graphemes / 256 scalars / 16 KiB)",
    ...
    "externalAction.title": "External Analysis Action",
    "externalAction.menuTitle": "Run a confirmed external analysis tool without a shell.",
    "externalAction.name": "Name",
    "externalAction.configJson": "Import Action JSON (optional)",
    "externalAction.configJsonPlaceholder": "Imported settings are reconfirmed before execution",
    "externalAction.configJsonHint": "Current configuration JSON (for export): {json}",
    "externalAction.executable": "Executable",
    "externalAction.arguments": "Arguments (JSON array)",
    "externalAction.argumentsHint":
      'Example: ["--input","{snapshot_file}"]. This is not a shell command string.',
    "externalAction.argumentsArrayError": "Arguments must be a JSON array containing only strings.",
    "externalAction.input": "Input",
    "externalAction.inputFile": "Saved file",
    "externalAction.inputSnapshot": "Current fixed snapshot",
    "externalAction.inputSelectionStdin": "Selection on stdin",
    "externalAction.inputSelectionFile": "Selection in private temporary file",
    "externalAction.output": "Output",
    "externalAction.outputPanel": "Result panel",
    "externalAction.outputTab": "New temporary tab",
    "externalAction.outputFile": "Output file",
    "externalAction.outputPath": "Output path",
    "externalAction.workingDirectory": "Working directory",
    "externalAction.timeout": "Timeout (seconds)",
    "externalAction.maxOutput": "Maximum output (MiB, stdout+stderr)",
    "externalAction.placeholderHint":
      "Placeholders: {file} {dir} {line} {column} {selection_file} {snapshot_file}. The child inherits the parent environment, but values are never shown in the UI or logs.",
    "externalAction.invalidConfig": "The external action configuration is invalid.",
    "externalAction.selectionRequired": "This input mode requires a selection.",
    "externalAction.outputPathRequired": "File output requires an output path.",
    "externalAction.confirmTitle": "Run this external program?",
    "externalAction.confirmWarning":
      "Verify the displayed executable and argument array. Repository-provided settings are never trusted automatically.",
    "externalAction.running": "Running {name}…",
    "externalAction.failed": "The external action could not run.",
    "externalAction.exitCode": "Exit code",
    "externalAction.duration": "Duration",
    "externalAction.canceled": "canceled",
    "externalAction.timedOut": "timed out",
    "externalAction.noExitCode": "unknown",
    "externalAction.outputTruncated": "truncated at the configured output limit",
    "externalAction.empty": "(empty)",
    "recognition.open": "Open Selected Path or URL",
    "recognition.confirmTitle": "Open this external target?",
    "recognition.kind.file": "File",
    "recognition.kind.directory": "Folder",
    "recognition.kind.url": "Web URL",
    "recognition.directory": "Recognized folder",
    ...
    "syntax.settings": "Syntax Schemes",
    "syntax.manage": "Manage Schemes...",
    "syntax.choose": "Choose a syntax scheme",
    "syntax.current": "Current Tab",
    "syntax.allSchemes": "All Schemes",
    "syntax.searchPlaceholder": "Search schemes or extensions",
    "syntax.assignExtension": "Assign This Extension",
    "syntax.mappings": "File name and glob mappings (first match wins)",
    "syntax.auto": "Auto (detect from file name)",
    "syntax.autoValue": "Auto · {scheme}",
    "syntax.statusValue": "Syntax scheme: {value}",
    "syntax.scheme": "Scheme",
    "syntax.glob": "File name or glob",
    "syntax.addFavorite": "Add to favorites",
    "syntax.removeFavorite": "Remove from favorites",
    "syntax.selectScheme": "Use {scheme} for the current tab",
    "syntax.moveUp": "Move Up",
    "syntax.moveDown": "Move Down",
    "syntax.import": "Import",
    "syntax.export": "Export",
    "syntax.importPrompt": "Paste syntax preference JSON",
    "syntax.importPartial": "Imported while skipping {count} invalid entries",
    "syntax.importReady": "Preferences loaded; save to apply them",
    "syntax.importError": "Could not read the syntax preference JSON",
    "syntax.exported": "Copied syntax preference JSON to the clipboard",
    "syntax.exportError": "Could not copy to the clipboard",
    "syntax.savePartial": "Saved while skipping {count} invalid mappings",
    "syntax.category.text": "Text",
    "syntax.category.data": "Data",
    "syntax.category.config": "Configuration",
    "syntax.category.markup": "Markup",
    "syntax.category.log": "Logs",
    "syntax.category.programming": "Programming",
    "syntax.category.build": "Build",
    "syntax.scheme.plain": "Plain Text",
    "syntax.scheme.json": "JSON / JSONC",
    "syntax.scheme.yaml": "YAML",
    "syntax.scheme.toml": "TOML",
