...
export const MESSAGES = {
  ja: {
    ...
    "dialog.progress.cancel": "キャンセル",
    "dialog.progress.cancelling": "キャンセル中…",
    "dialog.progress.lines": "{done} / {total} 行",
    "dialog.pick.selectFile": "選択",
    "dialog.pick.selectFolder": "このフォルダを選択",
    "dialog.pick.browse": "参照…",
    "dialog.pick.hintFile": "比較するファイルを選んでください。",
    "dialog.pick.hintFolder": "検索するフォルダを開いて「このフォルダを選択」を押してください。",
    "dialog.pick.pickFolderFirst": "フォルダを開いてください。",
  ...
  en: {
    ...
    "dialog.progress.lines": "{done} / {total} lines",
    "dialog.pick.selectFile": "Select",
    "dialog.pick.selectFolder": "Select this folder",
    "dialog.pick.browse": "Browse...",
    "dialog.pick.hintFile": "Choose the file to compare against.",
    "dialog.pick.hintFolder": "Open the folder to search, then press “Select this folder”.",
    "dialog.pick.pickFolderFirst": "Open a folder first.",
